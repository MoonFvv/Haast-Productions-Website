            ...
            {NAV_LINKS.map((link) => (
              link.href && link.href.startsWith('/') ? (
                ...
                <Link
                  ...
                  className={`relative px-5 py-2 rounded-full font-sans text-xs font-medium transition-all duration-300 ${
                    // @ts-ignore
                    link.primary
                      ? "bg-haast-accent text-white hover:bg-haast-accent/80 shadow-lg shadow-blue-500/20"
