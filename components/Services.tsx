...
const Gear: React.FC = () => {
    return (
        <section id="gear" className="py-32 relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {GEAR_CATEGORIES.map((category, idx) => (
                        <motion.div
                            ...
                            className="group relative bg-white/[0.02] border border-white/5 hover:border-haast-accent/40 transition-all duration-500 p-8 md:p-12 overflow-visible z-10 hover:z-20"
                        >
                            {/* HUD Corner Accents */}
